...
export const getSearch = _.memoize(async term => {
    const res = await fetch(`http://localhost:8983/solr/CZ4034/spell?debugQuery=true&df=text&hl.fl=text&hl=true&indent=true&q.op=OR&q=${term}&sort=like_count%20desc&wt=json`)
